	...
	<div class="inner-section about">
		<div class="row">
            ...
            //]]>
				...
				<div class="text-block">If you’re not in Manhattan, we ship worldwide and provide a 14-day Full Money-back Guarantee allowing you to shop with confidence and comfort using our easy and secure checkout. If you have any questions, every call is answered by a member of our professional customer service staff and never an automated receptionist.</div>
				<div class="text-block"><strong>Call us today at 1-888-730-0740</strong></div>
				<div class="about-video-container">
					<div class="about-video">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/S4cZuO4WXsA" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
				<div class="text-block about__small-descr"><strong>Chronostore</strong> is not an authorized dealer for or affiliated with BAUME & MERCIER, CARTIER, IWC, JAEGER-LECOULTRE, LANGE & SÖHNE, MONTBLANC, OFFICINE PANERAI, PIAGET, ROGER DUBUIS, VACHERON CONSTANTIN and VAN CLEEF & ARPELS, and the watches it sells are not new watches purchased directly from these manufacturers. The watches are, however, to the best of our knowledge, unworn. The manufacturer’s warranty will not be honored by these companies on the watches sold by Chronostore</div>
			</div>
		</div>
	</div>
</div>
