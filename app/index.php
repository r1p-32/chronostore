		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h2 class="homepage-title"><span><strong>Chronoblog</strong></span></h2>
					<div class="homepage-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-4">
	...
	<div class="insta-gallery">
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<h2 class="homepage-title"><span>Share your style with <strong>#chronostorenyc</strong></span></h2>
					<div class="homepage-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</div>
				</div>
			</div>
		</div>
